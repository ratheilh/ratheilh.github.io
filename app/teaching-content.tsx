...
const copy = {
  ...
  pedagogy: { fr: "Major de la cohorte 2025 de la Formation internationale en pédagogie universitaire numérique de l’Université libre de Bruxelles et titulaire de la Chaire du Sud. En mai 2026, j’y suis intervenu comme formateur sur les outils numériques au service de la pédagogie universitaire auprès d’enseignants-chercheurs de neuf pays.", en: "I was the top-ranked participant in the 2025 International Training in Digital University Pedagogy at the Université libre de Bruxelles and a Chair of the South awardee. In May 2026, I returned as a trainer, leading workshops on digital tools for university teaching for lecturers and researchers from nine countries." },
