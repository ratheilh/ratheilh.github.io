      ...
      <div className="home-grid">
        ...
        <div className="home-main">
          <header className="identity">
            <p className="eyebrow">Enseignant-chercheur en intelligence artificielle</p>
            <h1>Vinasetan Ratheil Houndji</h1>
            <p className="position">Maître de conférences des universités du CAMES<br />Chef du département Génie logiciel · Coordonnateur des formations de Licence et de Master</p>
          </header>
